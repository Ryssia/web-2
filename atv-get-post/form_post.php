...
<body>
    ...
    <div class="container">
        ...
        <form action="trata_post.php" method="post">
            ...
            <div class="form-floating mb-3">
                <input type="text" class="form-control" name="endereco" id="floatingEndereco" placeholder="Endereco">
                <label for="floatingEndereco">Endereco</label>
            </div>
            <div class="form-floating mb-3">
                <input type="text" class="form-control" name="cpf" id="floatingCpf" placeholder="Cpf">
