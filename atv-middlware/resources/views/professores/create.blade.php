    ...
    <form action="{{ route('professores.store') }}" method="POST">
        ...
        <div class="row">
            <div class="col" >
                ...
                <div class="btn-group">
                    <input type="radio" class="btn-check " name="status" id="ativo" value="1"  autocomplete="off" checked/>
        ...
        <div class="row">
            <div class="col" >
                <div class="form-floating mb-3">
                    <select name="eixo_id" class="form-control {{ $errors->has('eixo_id') ? 'is-invalid' : '' }}"  >    <!--caixa do select-->
