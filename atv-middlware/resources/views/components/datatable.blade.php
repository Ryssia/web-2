            ...
            @foreach ($data as $item)
                ...
                @endforeach
                    <td>
                        ...
                        @if($crud == "professores" || $crud == "disciplinas")
                        <a nohref style="cursor:pointer" href="{{route('aulas.index')}}" class="btn btn-warning m-1">
                        ...
                        @endif
                        <a nohref style="cursor:pointer" onclick="showInfoModal('{{ $item[$header[1]] }}')" class="btn btn-primary">
