...
<html lang="pt-br">
    <head>
        ...
        <!-- Define uma seção "titulo" aparece na aba-->
        <title>Sistema de Gerenciamento - @yield('titulo')</title>
    ...
    <body>
            ...
            <div class="container-fluid">
                <a href="{{route('index')}}" class="navbar-brand ms-sm-3">
                      <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" class="bi bi-clipboard2-pulse-fill" viewBox="0 0 16 16">
                        ...
                        <span class="ms-3 fs-5">Sistema de Gerenciamento</span>
                </a>
        ...
        <nav class="navbar fixed-bottom navbar-dark bg-secondary">
            <div class="container-fluid">
                <span class="text-white fw-light">&copy; design por Gil Eduardo de Andrade</span>
            </div>
        </nav>
    </body>
